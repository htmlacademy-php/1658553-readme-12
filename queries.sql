 ...
 */
INSERT INTO `content_type` (type_name, icon_name)
...
/*
 Пара пользователей
 */
INSERT INTO `user` (reg_date, email, login, password, avatar)
VALUES ('2015.05.05', 'firstemail@mail.ru', 'Вася', 'qwerty', 'img/some-man.jpg'),
       ('2015.05.06', 'secondemail@mail.ru', 'Петр', 'somehardpass', 'img/some-old-man.jpg'),
       ('2015.05.05', 'larisa@mail.ru', 'Лариса', 'qwerty', 'img/userpic-larisa-small.jpg'),
       ('2015.05.05', 'Vladikemail@mail.ru', 'Владик', 'qwerty', 'img/userpic.jpg'),
       ('2015.05.05', 'Victoremail@mail.ru', 'Виктор', 'qwerty', 'img/userpic-mark.jpg');
/*
 Все посты
 */
...
VALUES ('2020.08.23', 'Первый!', '1', '2'),
       ('2020.08.23', 'Как же скучно', '2', '1');
/*
 получаем список постов с сортировкой по популярности и вместе с именами авторов и типом контента
 */
SELECT `views_number`, `login`, `content_type_id`
FROM `post`
 ...
 */
INSERT INTO `subscribe` (user_subscribe_id, user_author_id)
VALUES ('1', '3');
/*
...
VALUES ('#Первый'),
       ...
       ('#Пыха'),
       ('#photo');
INSERT INTO `hashtag_post` (hashtag, post)
VALUES ('1', '5'),
       ('4', '5'),
       ('5', '5'),
       ('2', '3'),
       ...
       ('1', '1');
INSERT INTO `comment` (create_date, content, user_id, post_id)
VALUES ('2020.08.24', 'второй!', '5', '2'),
       ('2020.08.25', 'третий!', '2', '1'),
       ('2020.08.26', 'четвертый!!', '3', '2'),
