                ...
                <div class="post__indicators">
                    <div class="post__buttons">
                        ...
                        <a class="post__indicator post__indicator--likes button"
                           href="like.php?id=<?= $postMainContent['post_num'] ?>"
                           title="Лайк">
                        ...
                        <a class="post__indicator post__indicator--repost button"
                           href="repost.php?postId=<?= $postMainContent['post_num'] ?>"
                           title="Репост">
                            <svg class="post__indicator-icon" width="19"
                                 height="17">
                    ...
                    <span
                        class="post__view"><?= $postMainContent['views'] ?></span>
                </div>
                ...
                <div class="comments">
                    <form class="comments__form form" action="add-comment.php"
                        ...
                        <button class="comments__submit button button--green"
                                name="postId"
                                value="<?= $postMainContent['post_num'] ?>"
                                type="submit">Отправить
                        </button>
                    </form>
                    <?php
                    if ($commentList[0]['comment']): ?>
                            ...
                            if (($postMainContent['count_comments'] - 2) > 0
                                ...
                                <a class="comments__more-link"
                                   href="?post-id=<?= $postMainContent['post_num'] ?>&comment=all">
                                    ...
                                    <sup
                                        class="comments__amount"><?= $postMainContent['count_comments']
                                        - 2 ?></sup>
                                </a>
                            <?php
                            endif ?>
                ...
                <div class="post-details__user-info user__info">
                    <div class="post-details__avatar user__avatar">
                        <a class="post-details__avatar-link user__avatar-link"
                           href="profile.php?user=<?= $postMainContent['user_id'] ?>">
                            <img class="post-details__picture user__picture"
                                 src="<?= $postMainContent['avatar'] ?>"
                                 alt="Аватар пользователя">
                        </a>
                    </div>
