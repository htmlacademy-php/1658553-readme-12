...
<form class="registration__form form" action="registration.php" method="post"
    ...
    <div class="form__text-inputs-wrapper">
        <div class="form__text-inputs">
            ...
            <div class="registration__input-wrapper form__input-wrapper">
                <label class="registration__label form__label"
                       for="registration-login">Укажите ваше имя <span
                        class="form__input-required">*</span></label>
                <div class="form__input-section <?php
                if ($isPost
                    && ($errors['login'])
        ...
        if ($isPost && findErrors($errors)): ?>
            <div class="form__invalid-block">
                ...
                <ul class="form__invalid-list">
                    ...
                    <?php
                    if (($errors['password'])): ?>
                        <li class="form__invalid-item">Пароль. В пароле должны
                            быть только латинские буквы, пароле
                            должна быть хотя бы одна заглавная,
                            строчная буква, цифра, Спецсимвол ?@# и т.д. и
                            пароль должен быть не менее 8
