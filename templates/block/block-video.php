...
<form class="adding-post__form form" action="add.php?content-type=4"
      method="post"
    ...
    <div class="form__text-inputs-wrapper">
        <div class="form__text-inputs">
            ...
            <div class="adding-post__input-wrapper form__input-wrapper">
                <label class="adding-post__label form__label" for="videoUrl">Ссылка
                    youtube
                    <span class="form__input-required">*</span></label>
                <div class="form__input-section <?php
                if ($isPost
                    ...
                    <input class="adding-post__input form__input" id="videoUrl"
                           type="text"
