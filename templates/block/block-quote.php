    ...
    <div class="form__text-inputs-wrapper">
        <div class="form__text-inputs">
            ...
            <div class="adding-post__input-wrapper form__textarea-wrapper">
                ...
                <div class="form__input-section <?php
                if ($isPost && !empty($errors['cite-text'])): print 'form__input-section--error';
                endif; ?>">
                                            <textarea
            ...
            <div class="adding-post__textarea-wrapper form__input-wrapper">
                <label class="adding-post__label form__label" for="quote-author">Автор <span
                        class="form__input-required">*</span></label>
                <div class="form__input-section <?php
                if ($isPost && !empty($errors['quote-author'])): print 'form__input-section--error';
                endif; ?>">
            ...
            <div class="adding-post__input-wrapper form__input-wrapper">
                ...
                <div class="form__input-section <?php
                if ($isPost && !empty($errors['cite-tags'])): print 'form__input-section--error';
                endif; ?>">
                    <input class="adding-post__input form__input" id="cite-tags" type="text"
                           name="cite-tags" placeholder="Введите теги"
                           value="<?= getPostVal('cite-tags'); ?>">
                    <button class="form__error-button button" type="button">!<span
                            class="visually-hidden">Информация об ошибке</span></button>
                    <div class="form__error-text">
                        <h3 class="form__error-title">Заголовок сообщения</h3>
                        <p class="form__error-desc"><?php
                            print $errors['cite-tags'] ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        if ($isPost && count($errors) > 0): ?>
            <div class="form__invalid-block">
                ...
                <ul class="form__invalid-list">
                    ...
                    <?php
                    if (!empty($errors['cite-tags'])): ?>
                        <li class="form__invalid-item">Теги. <?php
                            print ($errors['cite-tags']) ?>
                        </li>
                    <?php
                    endif; ?>
                </ul>
